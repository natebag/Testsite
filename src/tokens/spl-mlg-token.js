...
import { createConnection, createMLGTokenConnection, CURRENT_NETWORK, CONNECTION_CONFIG, MLG_TOKEN_CONFIG as CONFIG_MLG, TOKEN_PROGRAMS } from '../../config/solana-config.js';
